...
Пожалуйста, структурируй и упорядочи указанные данные в лаконичной форме. Раздели информацию на ключевые показатели (например, «Гемоглобин», «Глюкоза» и т.п.), укажи, какие показатели присутствуют или отсутствуют, и представь результат в виде краткого списка – так, чтобы было понятно, на основе каких данных будут даны рекомендации.
"""
    try:
